...
const Banner = () => {
  return (
    <div className='flex flex-col xl:flex-row justify-center xl:justify-between items-center mb-32 mx-4 md:mx-32 px-6 xl:px-16 py-10 bg-[#2c2640] bg-bannerMobile lg:bg-bannerDesktop bg-no-repeat bg-right text-white text-center xl:text-left'>
