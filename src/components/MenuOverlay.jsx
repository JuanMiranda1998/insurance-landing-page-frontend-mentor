...
const MenuOverlay = ({ links }) => {
  return (
        <div className="h-[100lvh] block md:hidden  absolute top-0 left-0 bottom-0 right-0 translate-y-20 bg-[#2b282f] bg-[url('/background/bg-pattern-mobile-nav.svg')] bg-no-repeat bg-bottom text-white">
