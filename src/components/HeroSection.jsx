...
const HeroSection = () => {
  return (
    <div className='mb-12 lg:flex flex-row-reverse lg:px-32 lg:bg-[#2c2640] lg:bg-[url("/background/bg-pattern-intro-left-mobile.svg")] bg-no-repeat'>
      <div>
      ...
      <div className='text-center py-28 px-4 bg-[#2c2640] bg-[url("/background/bg-pattern-intro-left-mobile.svg")] bg-no-repeat lg:bg-transparent text-white'>
